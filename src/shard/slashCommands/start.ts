...
export default {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName("users").setDescription("The @ of the user/users to follow, separated by space.").setRequired(true)
        )
        .addStringOption(option =>
            option.setName("flags").setDescription("The flags to use, separated by space. Check docs for more info").setRequired(false)
        )
        .addStringOption(option =>
            option.setName("msg").setDescription("The message to send along with the tweet.").setRequired(false)
        ),
