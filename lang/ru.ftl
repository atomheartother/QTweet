...
langSuccess =
  ...
  Добро пожаловать в волшебный мир русского ящыка!
...
noSuchTwitterUser =
  ...
  Вы, скорее всего, пытались использовать их ник {$count ->
    [1] 
    *[other] 
  } и не их twitter {$count -> 
    [1] 
    *[other]
  }.
...
userLimit =
  ...
  - {-bНайти альтернативу QTweet{-b}: Да, вот и все, если эти варианты не работают для вас, я боюсь что не могу сделать что-нибудь еще для вас!
